...
# coding=utf-8
"""
MAnormFast - A robust model for quantitative comparison of ChIP-Seq data sets

This module provides the main command-line interface for MAnormFast.
"""
...
def command():
    """Main command function for MAnormFast."""
